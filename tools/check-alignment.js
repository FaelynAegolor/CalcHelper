...
const CASES = [
  ...
  { sec: '1.5', ref: '29', kind: 'solve', problem: '(t - 4)^2 = (t + 4)^2 + 32', official: [-2], v: 't', covers: null, what: 'looks quadratic but the x^2 CANCELS (linear)' },
  ...
  { sec: '1.5', ref: '55', kind: 'solve', problem: '(2x - 5)^2 = 81', official: [-2, 7], covers: null, what: 'solve directly by taking SQUARE ROOTS of both sides' },
  { sec: '1.5', ref: 'CS1', kind: 'solve', problem: 'x^2 - 6x + 11 = 0', official: [], covers: null, what: 'completing the square that leads to NO REAL SOLUTION' },
  ...
  { sec: '1.5', ref: 'CS5', kind: 'solve', problem: '3x^2 - 12x + 5 = 0', official: [2 - Math.sqrt(21) / 3, 2 + Math.sqrt(21) / 3], covers: null, what: 'completing the square when a != 1 (divide through first)' },
  ...
  { sec: '1.5', ref: '95', kind: 'solve', problem: 'sqrt(2x - 1) = sqrt(3x - 5)', official: [4], covers: null, what: 'RADICAL = RADICAL' },
  ...
  { sec: '1.5', ref: '112', kind: 'solve', problem: 'x - 5sqrt(x) + 6 = 0', official: [4, 9], covers: null, what: 'quadratic type with u = sqrt(x)' },
  ...
  { sec: '1.8', ref: '46', kind: 'ineq', problem: '5x^2 + 3x >= 3x^2 + 2', official: '(-inf, -2] U [1/2, inf)', covers: null, what: 'quadratic on BOTH sides - collect first' },
  { sec: '1.8', ref: '53', kind: 'ineq', problem: '(x - 4)(x + 2)^2 < 0', official: '(-inf, -2) U (-2, 4)', covers: null, what: 'REPEATED factor: sign does not change, and the hole stays excluded' },
  { sec: '1.8', ref: '57', kind: 'ineq', problem: 'x^3 - 4x > 0', official: '(-2, 0) U (2, inf)', covers: '1.8-e6, 1.8-g-cubic (needs factoring first)' },
  { sec: '1.8', ref: '65', kind: 'ineq', problem: '4/x < x', official: '(-2, 0) U (2, inf)', covers: null, what: 'rational inequality NOT already set against zero' },
  { sec: '1.8', ref: '83', kind: 'ineq', problem: '|3x - 2| >= 5', official: '(-inf, -1] U [7/3, inf)', covers: '1.8-e10, 1.8-g-abs' },
  { sec: '1.8', ref: '85', kind: 'ineq', problem: '|(x - 2)/3| < 2', official: '(-4, 8)', covers: null, what: 'absolute value of a FRACTION' },
  { sec: '1.8', ref: '89', kind: 'ineq', problem: '8 - |2x - 1| >= 6', official: '[-1/2, 3/2]', covers: null, what: 'must ISOLATE the absolute value first' },

  // ---------------------------------------------------------------- 1.9 Coordinate Plane
  { sec: '1.9', ref: 'dist-ex', kind: 'closer', pts: [[1, -2], [8, 9]], target: [5, 3], official: 'P', covers: null, what: 'WHICH point is closer (compare two distances)' },
  { sec: '1.9', ref: '35', kind: 'closer', pts: [[6, 7], [-5, 8]], target: [0, 0], official: 'P', covers: null, what: 'which point is closer to the origin' },
  ...
  { sec: '1.9', ref: '73a', kind: 'fact', what: 'intercepts of an implicit equation 9x^2 - 4y^2 = 36', covers: null },
  ...
  { sec: '1.10', ref: '63', kind: 'readline', problem: 'y = 4', official: { m: 0, b: 4 }, covers: null, what: 'slope / y-intercept of a HORIZONTAL line' },
  { sec: '1.10', ref: '65', kind: 'fact', what: 'x = 3 has NO slope and NO y-intercept', covers: null },
  ...
  { sec: '1.10', ref: '29', kind: 'fact', what: 'line through (1,7) and (1,6) is the vertical line x = 1', covers: null },
  { sec: '1.10', ref: '33', kind: 'rel', problem: 'y = 3x - 3', official: 'y = 3x - 3', vars: ['x', 'y'], covers: null, what: 'line from its x-intercept and y-intercept' },
  ...
  { sec: '1.10', ref: '41', kind: 'fact', what: 'line through (4,5) parallel to the X-AXIS is y = 5', covers: null },
  { sec: '1.10', ref: '45', kind: 'fact', what: 'line through (-1,2) parallel to the vertical line x = 5 is x = -1', covers: null },
  { sec: '1.10', ref: '46', kind: 'fact', what: 'line through (2,6) perpendicular to the horizontal line y = 1 is x = 2', covers: null },
  { sec: '1.10', ref: '50', kind: 'rel', problem: 'y = 2x - 7', official: 'y + 11 = 2(x + 2)', vars: ['x', 'y'], covers: null, what: 'perpendicular to a line given by TWO POINTS' }
];
