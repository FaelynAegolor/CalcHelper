...
(function () {
  ...
  function renderHome() {
    ...
    html += '<section class="hero"><h1>Hi ' + esc(name) + ' 👋</h1><p class="lead">Your own precalculus textbook. Read a topic in plain English, watch it worked through one step at a time, then practise — your answers <em>and</em> your working get marked straight away.</p>';
  ...
  function renderHelp() {
    ...
    let html = '<div class="page help"><h1>How to type maths</h1><p class="lead">Type answers the way you would on a calculator — you do not have to get the typing exactly right first time. The little <em>read as</em> preview under each box shows how your answer was understood, so if something is marked wrong, check there first: it is often the typing rather than the maths.</p>';
